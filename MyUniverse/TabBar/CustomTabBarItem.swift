...
extension CustomTabBarItem {
    ...
    var icon: UIImage? {
        ...
        case .menu:
            return UIImage(systemName: "line.3.horizontal")?.withTintColor(.white.withAlphaComponent(0.4), renderingMode: .alwaysOriginal)
        }
    }
    ...
    var selectedIcon: UIImage? {
        ...
        case .menu:
            return UIImage(systemName: "line.3.horizontal")?.withTintColor(.white, renderingMode: .alwaysOriginal)
        }
    }
