...
final class MyUniNaviVC: UINavigationController {
  ...
  private let navigationBarAppearance: UINavigationBarAppearance = {
    ...
    v.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor(resource: R.color.purple200) ?? .black]
    v.largeTitleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor(resource: R.color.purple200) ?? .black]
    return v
  }()
